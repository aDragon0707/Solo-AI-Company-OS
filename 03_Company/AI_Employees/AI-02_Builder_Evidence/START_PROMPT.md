...
2. [Vault Root]/02_Dashboards/DASHBOARD_Project_State.md
3. [Vault Root]/03_Company/AI_Worklogs/WORKLOG_INDEX.md
4. [Vault Root]/03_Company/AI_Employees/COORDINATION_PROTOCOL.md
5. [Vault Root]/03_Company/AI_Employees/AI-02_Builder_Evidence/ROLE.md
...
6. handoff context for the next AI
7. worklog status
```
